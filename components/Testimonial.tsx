const Testimonial = () => {
    ...
    return (
        <section id="testimonials" className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-bgred to-bgyellow">
            <h1 className="text-5xl md:text-6xl font-semibold text-textgray">Testimonials</h1>
                ...
                {testimonials.map((testimonial, key) => (
                    <div className="bg-bgwhite rounded-xl px-2 py-5 text-center lg:hover:shadow-lg lg:hover:shadow-bgbrown lg:hover:bg-opacity-100 transition-all ease-in-out" key={key}>
                        <div className="flex justify-around">
                            <h1 className="text-xl sm:text-3xl lg:text-7xl font-serif font-bold text-bgbrown opacity-0 sm:opacity-100">"</h1>
