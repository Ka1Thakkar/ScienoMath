...
const HomeScreen = () => {
    return (
        <section id='home' className=" bg-gradient-to-b from-bgwhite to-bgyellow min-h-screen flex md:flex-row flex-col-reverse items-center justify-center gap-5 md:gap-10">
            <div className='md:h-full h-2/5 px-10 md:px-0 md:w-2/5 text-center md:text-right'>
                ...
                <h1 className='text-5xl lg:text-7xl 2xl:text-8xl font-bold text-bgbrown'>ScienoMath</h1>
